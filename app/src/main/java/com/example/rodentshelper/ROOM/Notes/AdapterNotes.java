...
public class AdapterNotes extends RecyclerView.Adapter<AdapterNotes.viewHolder>
{
    ...
    public AdapterNotes(List<NotesModel> notesModel) {
    ...
    public void onBindViewHolder(@NonNull @NotNull viewHolder holder, int position) {
        ...
        holder.editTextTopic_notes.setText(notesModel.get(position).getTopic());
        holder.editTextContent_notes.setText(notesModel.get(position).getContent());


        if (notesModel.get(position).getTopic().equals(""))
            holder.editTextTopic_notes.setText("brak tematu");
        else
            holder.editTextTopic_notes.setText(notesModel.get(position).getTopic().toString());
    ...
    private void deleteNotes(Context context, viewHolder holder) {
        ...
        alert.setPositiveButton("Tak", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                dao.deleteNotesById(notesModel.get(holder.getAdapterPosition()).getId());
